<template>
  <div class="Dashboard">
    ...
    <div class="uk-padding">
      <InvoiceCWViewPage class = "uk-container uk-align-center"  v-bind:user="user" v-bind:fp="fp" v-bind:fp_info="fp_info" v-bind:child_info="child_info" v-bind:invoice_info="invoice_info.records" v-bind:object="invoice_object"/>
    </div>
  </div>
</template>
...
import InvoiceCWViewPage from '@/components/InvoiceCWViewPage.vue';
